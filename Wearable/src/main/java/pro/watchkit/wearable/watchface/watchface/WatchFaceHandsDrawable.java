...
//        hub.addCircle(mCenterX, mCenterY, HUB_RADIUS_PERCENT * pc, Path.Direction.CCW);
        ...
        Paint hourHandPaint = mPalette.getPaintFromPreset(preset.getHourHandStyle());
...
//        }
        ...
        Paint minuteHandPaint = mPalette.getPaintFromPreset(preset.getMinuteHandStyle());
...
//                true, false, minutesRotation, minuteHub);
        ...
        if (!mStateObject.ambient) {
            Paint secondHandPaint = mPalette.getPaintFromPreset(preset.getSecondHandStyle());
