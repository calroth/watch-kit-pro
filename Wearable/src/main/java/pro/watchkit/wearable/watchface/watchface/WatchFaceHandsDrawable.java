...
//        hub.addCircle(mCenterX, mCenterY, HUB_RADIUS_PERCENT * pc, Path.Direction.CCW);
        ...
        Paint hourHandPaint = mPaintBox.getPaintFromPreset(preset.getHourHandStyle());
...
//        }
        ...
        Paint minuteHandPaint = mPaintBox.getPaintFromPreset(preset.getMinuteHandStyle());
...
//                true, false, minutesRotation, minuteHub);
        ...
        if (!mStateObject.ambient) {
            Paint secondHandPaint = mPaintBox.getPaintFromPreset(preset.getSecondHandStyle());
