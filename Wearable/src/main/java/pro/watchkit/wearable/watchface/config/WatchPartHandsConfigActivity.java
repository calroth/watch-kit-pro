 ...
 */
public class WatchPartHandsConfigActivity extends Activity {

    static final int COMPLICATION_CONFIG_REQUEST_CODE = 1001;
    static final int UPDATED_CONFIG_REDRAW_PLEASE_REQUEST_CODE = 1002;
    private static final String TAG = WatchPartHandsConfigActivity.class.getSimpleName();
    private WatchPartHandsConfigRecyclerViewAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new WatchPartHandsConfigRecyclerViewAdapter(
                getApplicationContext(),
                WatchPartHandsConfigData.getDataToPopulateAdapter(this));
